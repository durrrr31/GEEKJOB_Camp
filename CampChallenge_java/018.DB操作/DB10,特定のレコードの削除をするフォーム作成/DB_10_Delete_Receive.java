 ...
 * @author guest1Day
 */
public class DB_10_Delete_Receive extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int deleteID = Integer.parseInt(request.getParameter("id"));     // 削除するIDの番号をint型に変換しdeleteIDに代入します。
            
                Connection db_con = null;                   //   JDBCを利用するための変数を宣言
