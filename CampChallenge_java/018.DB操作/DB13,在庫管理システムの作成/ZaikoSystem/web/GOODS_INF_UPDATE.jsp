<%-- 
    Document   : GOODS_INF_UPDATE
    Created on : 2018/06/20, 15:05:56
    Author     : guest1Day
--%>
    ...
    <body>
        ...
        HttpSession s = request.getSession();
            ...
            try{
                ...
                db_st = db_con.prepareStatement("update goods set zaikosu=? where goodsname=?");
                db_st.setInt(1, Integer.parseInt(request.getParameter("zaikosu")));
                db_st.setString(2, request.getParameter("GoodsName"));
