...
<%
    ...
    //  フォームの初期値をsetするために、セッションに格納した情報を受け取ります。
    HttpSession hs = request.getSession();
    
    UserDataBeans udb = (UserDataBeans)hs.getAttribute("Data");
%>
...
<html>
    ...
    <form action="UpdateResult" method="POST">
        ...
        <select name="year">
            ...
            <!--誕生日にiが含まれているときにそれを初期値として選択させます。-->
        ...
        自己紹介文
        <br>
        <textarea name="comment" rows=10 cols=50 style="resize:none" wrap="hard"><%=udb.getComment().toString()%></textarea><br><br>
